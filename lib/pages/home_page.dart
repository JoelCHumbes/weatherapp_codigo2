...
class _HomePageState extends State<HomePage> {
  ...
  getData(String city) async {
    ...
    Uri _url = Uri.parse(
        "https://api.openweathermap.org/data/2.5/weather?q=$city&appid=7eb2f4fe52dc1d5797711fd3f9a8b1ab");
  ...
  getDataLocation() async {
    ...
    Uri _url = Uri.parse(
        "https://api.openweathermap.org/data/2.5/weather?lat=${position.latitude}&lon=${position.longitude}&appid=7eb2f4fe52dc1d5797711fd3f9a8b1ab");
    http.Response response = await http.get(_url);
    if (response.statusCode == 200) {
      Map myMap = json.decode(response.body);
      temp = myMap["main"]["temp"];
    ...
    return Scaffold(
      ...
      body: Stack(
        ...
        children: [
                        ...
                        TextFormField(
                          ...
                          validator: (value) {
                            if (value != null && value.isEmpty) {
                              return "* Obligatorio ingresar Ciudad";
                            }
          ...
          //Carga de Datos CircularProgreess
